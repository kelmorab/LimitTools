...
parser.add_option("-n", "--number", dest="number", default="0", type="string", help="number")
...
hist_fit_s  = ROOT.TH1F("prefit_fit_s"   ,"S+B fit Nuisances   ;;#theta ",myprefitsize,0,myprefitsize)
hist_prefit = ROOT.TH1F("prefit_nuisancs","Prefit Nuisances    ;;#theta ",myprefitsize,0,myprefitsize)
...
if options.plotfile:
    ...
    hist_prefit.GetXaxis().SetLabelSize(0.02)
    hist_prefit.Draw("E2")
   ...
   # gr_fit_s.Draw("EPsame")
    ...
    canvas_nuis.SaveAs(options.plotfile+".pdf")
