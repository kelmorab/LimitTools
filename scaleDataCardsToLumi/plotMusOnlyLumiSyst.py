...
from resultsOnlyLumiSyst import results
...
for lumi in ['scenario1','scenario2']:
  ...
  legend.AddEntry(g_mus['scenario1_'+mu], " #sqrt{s}=13 TeV Scenario 1", "l")
  legend.AddEntry(g_mus['scenario2_'+mu], "#sqrt{s}=13 TeV Only lumi unc.", "l")
  legend.Draw("same")
